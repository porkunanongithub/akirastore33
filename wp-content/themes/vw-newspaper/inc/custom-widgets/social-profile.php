...
// This is where the action happens
	public function widget( $args, $instance ) {
		...
		//echo __( 'Hello, World!', 'vw-newspaper' );
	...
	public function form( $instance ) {
		...
		?>	
			...
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Google+:','vw-newspaper'); ?></label>
