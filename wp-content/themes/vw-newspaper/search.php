...
<div class="container">
    ...
    <?php
        $theme_lay = get_theme_mod( 'vw_hair_salon_theme_options','Right Sidebar');
        if($theme_lay == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div id="our-services" class="services col-md-8 col-sm-8">
                    <h1 class="entry-title"><?php printf( esc_html( 'Results For: %s','vw-newspaper') '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1> 
                    <?php if ( have_posts() ) :
                        /* Start the Loop */
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-newspaper' ),
                                'next_text'          => __( 'Next page', 'vw-newspaper' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-newspaper' ) . ' </span>',
                            ) );
                        ?>
