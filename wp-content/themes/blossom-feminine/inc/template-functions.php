...
function blossom_feminine_breadcrumb(){    
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) && ! is_front_page() && ! is_search() ){
        ...
        if( is_home() ){
            ...
            echo '<a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) ) . '" itemprop="item">' . esc_html( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) . '</a> <span class="separator">' . esc_html( $delimiter ) . '</span> ';
            echo '<a href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'blossom-feminine' ) ), get_the_time( __( 'm', 'blossom-feminine' ) ) ) ) . '" itemprop="item">' . esc_html( get_the_time( __( 'F', 'blossom-feminine' ) ) ) . '</a> <span class="separator">' . esc_html( $delimiter ) . '</span> ';
